...
├── rules/                           # Правила оформления документов
│   └── roles-management-rules.md    # Основные правила и шаблоны
├── templates/                       # Шаблоны для новых ролей
│   └── role-template.md             # Шаблон унифицированной роли
├── tests/                           # Тесты валидации
│   └── validation-tests.md          # Система тестирования
├── validate-skills.ps1              # PowerShell скрипт валидации
└── README.md                        # Этот файл
```
...
#### `rules/roles-management-rules.md`
- **Описание:** Правила оформления документов ролей
- **Формат:** Markdown с шаблонами и правилами
- **Содержание:** Стандарты структуры, форматирования и валидации

#### `templates/role-template.md`
- **Описание:** Шаблон для создания новых ролей
- **Формат:** Markdown с заполнителями
- **Содержание:** Готовая структура для новой роли

#### `tests/validation-tests.md`
- **Описание:** Система тестирования документов ролей
- **Формат:** Markdown с чек-листами
- **Содержание:** Тесты полноты, структуры и соответствия правилам

#### `validate-skills.ps1`
- **Описание:** PowerShell скрипт автоматической валидации
- **Формат:** PowerShell скрипт
- **Содержание:** Автоматические тесты структуры и навыков
