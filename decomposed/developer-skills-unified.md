...
### 7. Получение и внедрение ревью

**Описание навыка:** Способность получать обратную связь от старших коллег и внедрять предложения по улучшению.

**Применение в ролях:**

#### Back-end Developer Middle L4
- **Ожидаемый результат:** Получает ревью от старших коллег после написания тех. постановки проблемы и до реализации
- **Контекст:** Ревью технической постановки
- **Уровень компетенции:** Получение ревью постановки

#### Back-end Developer Middle L5
- **Ожидаемый результат:** Получает ревью от старших коллег после написания тех. постановки проблемы и до реализации
- **Контекст:** Ревью технической постановки с учетом рефакторинга
- **Уровень компетенции:** Получение ревью постановки

#### Back-end Developer Middle L6
- **Ожидаемый результат:** Получает ревью своей работы от старших коллег после реализации
- **Контекст:** Ревью готовой работы
- **Уровень компетенции:** Получение ревью результата

#### Back-end Developer Senior L7
- **Ожидаемый результат:** Получает ревью от старших коллег после написания тех. постановки по проектам и до реализации
- **Контекст:** Ревью технической постановки проектов
- **Уровень компетенции:** Получение ревью проектной постановки

#### Back-end Developer Senior L8
- **Ожидаемый результат:** Получает ревью от старших коллег после реализации
- **Контекст:** Ревью готовой работы с исследованиями
- **Уровень компетенции:** Получение ревью результата
...
| Навык | Junior | Middle | Senior | Architect |
|-------|--------|--------|--------|-----------|
